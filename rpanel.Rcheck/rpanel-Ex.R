...
### Name: Astrand
### Title: Physical working capacity in relation to sex and age
### Aliases: Astrand
...
## Not run: 
##D plot(Heart_rate ~ Age, data = Astrand)
## End(Not run)


base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("Astrand", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("Clyde")
### * Clyde
...
base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: Hyde
### Title: Data on longevity and father's age, from the Hyde genealogy
### Aliases: Hyde
### Keywords: iplot dynamic
...
## Not run: 
##D ind  <- rep(1:nrow(Hyde), Hyde$Frequency)
##D Hyde <- Hyde[ind, 1:2]
##D hist(Hyde$Child)
## End(Not run)
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("Hyde", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("Loch_Leven")
### * Loch_Leven
...
## Not run: 
##D with(Loch_Leven, plot(year, log(chla)))
## End(Not run)


base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("Loch_Leven", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("SO2")
### * SO2
...
base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: cholesterol
### Title: Cholesterol and age for samples of women in Iowa and Nebraska
### Aliases: cholesterol
### Keywords: iplot dynamic
...
## Not run: 
##D library(ggplot2)
##D ggplot(cholesterol, aes(Age, Cholesterol, col = Location)) + geom_point()
## End(Not run)


base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("cholesterol", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("flour_beetles")
### * flour_beetles
...
base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: flour_beetles
### Title: Toxins for the eradication of flour beetles
### Aliases: flour_beetles
### Keywords: iplot dynamic

### ** Examples

## Not run: 
##D hacid <- subset(flour_beetles, Toxin == "Hydrocyanic_acid")
##D plot(Dead / (Living + Dead) ~ Concentration, data = hacid)
## End(Not run)


base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("flour_beetles", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("gullweight")
### * gullweight
...
base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: mammal_speed
### Title: Data on maximal running speed and body mass in terrestrial
###   mammals
### Aliases: mammal_speed
### Keywords: iplot dynamic

### ** Examples

## Not run: 
##D if (require(ggplot2, quietly = TRUE)) {
##D   ggplot(mammal_speed, aes(log(Mass), log(Speed), col = Family)) + geom_point()
##D }
## End(Not run)


base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("mammal_speed", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("poisons")
### * poisons
...
cleanEx()
nameEx("rp.coefficients")
### * rp.coefficients

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: rp.coefficients
### Title: Graphical display of the effects of the coefficients in a linear
###   or generalised linear model
### Aliases: rp.coefficients

### ** Examples

## Not run: 
##D    model <- lm(Giving ~ Employ + Elect + Attend + 1, data = CofE)
##D    rp.coefficients(model)
##D    
##D    # Change colours
##D    
##D    # Options for labelling
##D    plt <- rp.coefficients(model)
##D    plt + ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 90))
##D    plt + ggplot2::scale_x_discrete(labels = scales::label_wrap(5))
##D    plt + ggplot2::coord_flip()
##D    
## End(Not run)
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("rp.coefficients", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
...
base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: rp.colours
### Title: Specify the colours to be used in some 'rpanel' functions.
### Aliases: rp.colours rp.colors
### Keywords: iplot dynamic

### ** Examples

## Not run: 
##D # View the defauklt colours.
##D rp.colours()
##D 
##D # Alter particular colours
##D model <- lm(Giving ~ Attend + Employ, data = CofE)
##D rp.coefficients(model)
##D rp.coefficients(model, cols = c('estimate' = 'darkgreen'))
## End(Not run)


base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("rp.colours", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("rp.combo")
### * rp.combo
...
base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: rp.contingency
### Title: Visualisation of two-way contingency tables with uncertainties
### Aliases: rp.contingency
### Keywords: iplot dynamic

### ** Examples

## Not run: 
##D    x <- matrix(c(19, 41, 32, 28), ncol = 2,
##D             dimnames = list(c("non-smoker", "smoker"),
##D                             c("cases", "controls")))
##D    rp.contingency(x)
##D    rp.contingency(x, style = "aligned")
##D    rp.contingency(x, uncertainty = TRUE)
##D    rp.contingency(x, uncertainty = TRUE) + ggplot2::coord_flip()
## End(Not run)


base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("rp.contingency", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("rp.control")
### * rp.control
...
## Not run: 
##D   rp.datalink()
##D   rp.datalink("~/Desktop/temp", "set local directory")
##D   rp.datalink("global_temperature")
##D   
##D   # Reading from a file within a zip file
##D   zfile   <- rp.datalink("children_services")
##D   dirname <- "Data and Code CSRR Strand 3 - August 2023 Update"
##D   path <- unz(zfile, paste(dirname, "Example_Indicator_CSR.csv", sep = "/"))
##D   if (!requireNamespace("readr", quietly = TRUE)) 
##D     indicator <- read_csv(path, skip = 6, col_names = c("LA", 2011:2021))
##D   
## End(Not run)


base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("rp.datalink", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
...
base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: rp.drop1
### Title: Display in graphical form the results of dropping all single
###   terms from a model.
### Aliases: rp.drop1
### Keywords: iplot dynamic
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("rp.drop1", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("rp.firth")
### * rp.firth
...
base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: rp.lm
### Title: Graphical display of linear models with no more than two
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("rp.lm", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("rp.logistic")
### * rp.logistic
...
##D   #  rgl::lines3d(a$x, a$y, a$z, col = "green", size = 2) 
## End(Not run)
...
##D     rp.regression(cbind(Employ, Attend), Giving, model = "Employ and Attend", panel = FALSE)
##D   })
## End(Not run)
...
base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: rp.sample
### Title: Interactive exploration of sampling variation
### Aliases: rp.sample
### Keywords: iplot dynamic
...
base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: rp.t_test
### Title: Graphical display for inference in comparing the means of one or
###   two samples
### Aliases: rp.t_test
### Keywords: iplot dynamic
...
##D rp.t_test(x)
##D rp.t_test(x, mu = 0)
##D rp.t_test(x, uncertainty = 'sample mean')
##D rp.t_test(x, uncertainty = 'reference')
##D 
##D g <- factor(rep(1:2, each = 25))
##D plt <- rp.t_test(x ~ g)
##D plt + ggplot2::ggtitle("Two-sample inference")
## End(Not run)


base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("rp.t_test", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("rp.tables")
### * rp.tables
...
base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: rp.tkrplot
### Title: Facilities for placing R plots inside 'tcltk' windows.
...
base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: rp.wrangle
### Title: Collate and organise specific datasets
### Aliases: rp.wrangle
...
## Not run: 
##D   rp.wrangle()
##D   rp.wrangle("cofe_2019")
## End(Not run)


base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("rp.wrangle", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
...
### Title: Toxins for the eradication of flour beetles
### Aliases: vasoconstriction
### Keywords: iplot dynamic

### ** Examples

## Not run: 
##D with(vasoconstriction, {
##D   plot(log(Rate), log(Volume), type = 'n')
##D   text(log(Rate), log(Volume), as.character(Vasoconstriction))
##D })
## End(Not run)


base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("vasoconstriction", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("worldbank")
### * worldbank
